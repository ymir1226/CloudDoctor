// miniprogram/pages/doctor_reply/doctor_reply.js
const app = getApp()
//云文件存储路径
...
/**
  * 新增处方详细信息
  */
 addPrescription: function (id) {
  var that = this;
  //请求回复信息
  wx.request({
    url: 'https://yiwei.run/api/prescription/addPrescription',
    data: {
      id_inquiry:id
    },
    header: {
